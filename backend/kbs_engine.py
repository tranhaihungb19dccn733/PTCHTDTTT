	...
	def __init__(self) -> None:
		self.rules = [
			...
			ExpertRule(
				...
				title="Cholesterol máu cao",
				message="Chỉ số cholesterol cao là yếu tố nguy cơ của xơ vữa động mạch.",
				recommendation="Cần đánh giá lipid máu đầy đủ và điều chỉnh chế độ ăn ít mỡ bão hòa.",
